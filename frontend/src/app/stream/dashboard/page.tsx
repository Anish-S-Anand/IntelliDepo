...
export default function DashboardSummaryPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-[radial-gradient(circle_at_top,_rgba(157,227,229,0.34),_transparent_34%),linear-gradient(180deg,_#eef8f8_0%,_#f8fcfc_100%)] lg:h-screen">
      <header className="shrink-0 border-b border-slate-100/80 bg-white/55 px-8 py-4 backdrop-blur-sm">
