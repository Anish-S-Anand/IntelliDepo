...
const config: LayerConfig = {
  ...
  modules: [
    ...
    { name: "Zone Allocation", description: "Dynamic zone assignment engine with demand-based reallocation and seasonal configuration support.", status: "active", kpis: [{ label: "Zones", value: "24" }, { label: "Reallocations", value: "5" }, { label: "Efficiency", value: "87%" }, { label: "Travel Time Saved", value: "18min" }] },
