...
const FEATURE_NAV = [
  ...
  { label: "Simulation & Integration", href: "/stream/macropulse/simulation", icon: GitMerge },
  { label: "Financial Impact", href: "/stream/macropulse/financial", icon: TrendingUp },
  { label: "MacroPulse Agent", href: "/stream/macropulse/agent", icon: Bot },
  { label: "CFO Brief", href: "/stream/macropulse/cfo-brief", icon: FileText },
];

const SUPPORT_NAV = [
  { label: "Regional Data Sources", href: "/stream/macropulse/datasources", icon: Database },
...
export default function MacroPulseSidebar() {
  ...
  return (
    <aside className="macropulse-sidebar relative flex h-screen w-[280px] shrink-0 flex-col text-white">
