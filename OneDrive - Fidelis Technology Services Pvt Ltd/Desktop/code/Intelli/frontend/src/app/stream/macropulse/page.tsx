...
const CAPABILITIES = [
  ...
  },
  {
    ...
    description: "Sensitivity matrix that translates macro movements into ₹ Cr P&L impact on your loan book, FX exposure, COGS, G-Sec portfolio, and supply chain.",
    href: "/stream/macropulse/financial",
  ...
  },
  {
    ...
    description: "Model historical shocks (2008 crisis, COVID, oil crash) or custom macro scenarios to stress-test margins and quantify worst-case P&L exposure.",
  ...
  {
    icon: AlertTriangle,
    title: "Alert & Risk Workflow",
    description: "P1/P2/P3 alert classification with confidence scoring, human-in-the-loop review queue, PII guardrails, and Novu-powered notification dispatch.",
    href: "/stream/macropulse/risk",
  ...
  },
  {
    ...
    description: "Multi-region macro intelligence spanning India (RBI/SEBI), UAE (CBUAE), Saudi Arabia (SAMA), and global commodity and credit markets.",
    href: "/stream/macropulse/regional",
    color: "text-blue-700",
    bg: "bg-blue-50",
