...
export default function RealTimeMonitoringPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col gap-4 overflow-hidden px-6 py-5 lg:h-screen lg:px-8">
      ...
      <div className="min-h-0 flex-1 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        ...
        <div className="grid h-full auto-rows-fr divide-gray-100 md:grid-cols-2 md:divide-x xl:grid-cols-4">
          {feed.map((item) => (
